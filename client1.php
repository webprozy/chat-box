...
<script type="text/javascript">	
    // in this function data will send to the client1 php file and show present data in chat box in same page
		function addComment() {
			...
			if( $('#user_name').val().length == 0 || $('#user_comment').val().length ==0) {
			...
			$.ajax({
				url : "http://localhost/adarsh1php/adarsh%20king/chat-box/server1.php",
				type : "get" , 
				data : requestData , 
				dataType : "json" , 
		...
		// in this you will all data present in database of chat with user name
		function updateChat() {
